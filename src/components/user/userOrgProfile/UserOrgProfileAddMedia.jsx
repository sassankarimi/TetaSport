...
export class UserOrgProfileAddMedia extends Component {
    static displayName = UserOrgProfileAddMedia.name;
    ...
    //اینپوت داینامیک قوانین
    addInputs() {
        return this.state.AparatInputLinks.map((el, i) =>
            <div key={i} style={{ position: 'relative', paddingTop: 7 }}>
                <input type="text" value={el || ''} onChange={this.handleChange.bind(this, i)} className='createLeague-leagueInputs createLeague-leagueName form-control' placeholder='لینک آپارات' />
                ...
                data => {
                    if (data) {
                        let aparatLinkArr = this.state.Aparatlinks;
                         //باراول که آرایه خالیست کلید ویدیو نداریم
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <div className='col-12' style={{ padding: '40px 70px 10px 70px' }}>
                                {/* افزودن لینک آپارات*/}
                                <label style={{ fontFamily: 'iranyekanBold', color: '#5C5D5B', fontSize: 15 }}>لینک های آپارات</label>
                                {this.addInputs()}
                                <div className='col-12' style={{ padding: '7px 0px 7px' }}>
                                    <input readOnly style={{ cursor: 'pointer' }} type="text" className='Input-StyledInputs Input-AddNewInput form-control' placeholder='افزودن لینک آپارات' onClick={this.addClick.bind(this)} />
                                </div>
                            </div>
